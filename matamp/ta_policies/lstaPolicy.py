...
@ Author: Gang Xu
@ Date: 2022.12.16
@ Function: Lazy Sample based Task Allocation (LSTA) Algorithm implemented in decentralized version
@ Paper: Efficient Decentralized Task Allocation for UAV Swarms in Multi-target Surveillance Missions
"""
import copy
import numpy as np
